    ...
    <div class="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <section class="space-y-6">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <p class="mt-2 text-sm text-slate-600">Retrouvez ici l'ensemble des réservations associées à votre compte.</p>
            </div>

            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
                <h2 class="text-lg font-semibold text-slate-950">Accès utiles</h2>
                ...
                <div class="rounded-2xl border border-slate-200 px-4 py-4">
                    <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        ...
                        <div class="flex flex-wrap gap-3">
                            ...
                            <form method="POST" action="{{ route('dashboard.bookings.destroy', $booking) }}" onsubmit="return confirm('Voulez-vous vraiment annuler cette réservation ?');">
                                @csrf
                                @method('DELETE')
