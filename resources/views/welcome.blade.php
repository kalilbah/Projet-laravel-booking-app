...
<div class="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
    <div>
        ...
        <h1 class="mt-4 max-w-3xl text-4xl font-black tracking-tight text-slate-950 sm:text-5xl">
            Consultez nos biens, choisissez vos dates et gérez vos réservations en quelques clics.
        </h1>
    </div>
    ...
    <div class="grid gap-4 sm:grid-cols-2">
        ...
        {{-- Bloc d'accès rapide vers les principales zones du projet. --}}
...
<section class="space-y-8">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h2 class="text-2xl font-bold text-slate-950">Nos propriétés</h2>
        </div>

        @auth
        {{-- Bouton affiché pour un utilisateur connecté afin d'accéder à ses réservations. --}}
        <x-ui.button href="{{ route('dashboard') }}" variant="secondary" size="md">
            Voir mes réservations
        </x-ui.button>
        @else
        {{-- Bouton affiché pour inviter un visiteur à créer un compte. --}}
